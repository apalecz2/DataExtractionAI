// Old test UI to view the ocr and llm
            ...
            <div className="mb-4 flex flex-col gap-3 rounded-3xl border border-slate-200 bg-white px-5 py-4 shadow-sm">
                ...
                <div className="flex items-center gap-2 text-sm">
                    <span className={`rounded-full border px-3 py-1 font-medium ${isServerReady ? "border-emerald-200 bg-emerald-50 text-emerald-700" : "border-amber-200 bg-amber-50 text-amber-700"}`}>
                        {isServerReady ? "Backend Ready" : isServerStarting ? "Loading LLM" : "LLM Unloaded"}
                    </span>
                    <button
                        type="button"
                        onClick={handleToggleServer}
                        disabled={isLoading}
                        className={`rounded-full px-3 py-1 font-medium transition-colors ${isServerReady ? "border border-slate-200 bg-white text-slate-700 hover:bg-slate-50" : "border border-slate-900 bg-slate-900 text-white hover:bg-slate-800"} disabled:cursor-not-allowed disabled:opacity-50`}
                    >
                        {isServerReady ? "Unload LLM" : isServerStarting ? "Loading..." : "Load LLM"}
                    </button>
                </div>
            </div>
