...
export default function Dashboard(): React.ReactElement {
    ...
    return (
        <main className="relative h-full overflow-hidden bg-background">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(0,0,0,0.08),transparent_46%),linear-gradient(180deg,rgba(255,255,255,0.58),rgba(255,255,255,0))] dark:bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.06),transparent_42%),linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0))]" />
            ...
            <div className="relative flex h-full flex-col gap-8 px-margin-page py-10">
                <section className="mx-auto flex w-full max-w-6xl flex-1 flex-col justify-center gap-10 lg:flex-row lg:items-center">
                    ...
                    <div className="w-full max-w-2xl flex-1 rounded-4xl border border-outline-variant bg-surface-bright p-5 shadow-[0_24px_80px_rgba(0,0,0,0.08)] shadow-black/10">
                        <div
                            className={`group relative overflow-hidden rounded-[1.75rem] border border-dashed p-6 transition-all duration-300 ${isDragging
                            ...
                            onDrop={handleDrop}
                        >
                            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(0,0,0,0.06),transparent_60%)] opacity-70" />
                            ...
                            <div className="relative z-0 flex flex-col gap-6">
                                ...
                                <div className="rounded-3xl border border-outline-variant bg-surface-bright px-4 py-3 shadow-sm shadow-black/5">
                                ...
                                <div className="flex flex-wrap items-center justify-between gap-3 rounded-3xl border border-outline-variant bg-surface-container-low px-4 py-4">
                                    <div>
